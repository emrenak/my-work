...
public class App 
{
    public static void main( String[] args )
    {
		...
		VendorSpecificAttribute vsatt2 = new VendorSpecificAttribute(14122);
		vsatt2.addSubAttribute("WISPr-Location-ID", "krtl");
		/*VendorSpecificAttribute vsatt1 = new VendorSpecificAttribute(14123);
		vsatt1.addSubAttribute("CISCO-BANDWIDTH-LIMIT", "3");
		vsatt1.addSubAttribute("CISCO-Location-Name", "Kartal");*/
		coaRequest.addAttribute(vsatt2);
		try {
